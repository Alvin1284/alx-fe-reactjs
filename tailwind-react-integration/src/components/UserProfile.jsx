function UserProfile() {
  return (
    <div className="bg-gray-100 p-8 md:p-8 sm:p-4 max-w-sm mx-auto my-20 rounded-lg shadow-lg">
      <img className="rounded-full md:w-36 h-36 sm:w-24 sm:h-24 mx-auto" src="https://via.placeholder.com/150" alt="User" />
